...
type TeamMember struct {
	...
	Role              TeamRole `thrift:"role,4" form:"role" json:"role" query:"role"`
...
type TeamInvitation struct {
	...
	Role            TeamRole         `thrift:"role,6" form:"role" json:"role" query:"role"`
	Status          InvitationStatus `thrift:"status,7" form:"status" json:"status" query:"status"`
...
type GetUserTeamsResp struct {
	Teams    []*Team          `thrift:"teams,1" form:"teams" json:"teams" query:"teams"`
...
type InviteUserReq struct {
	...
	Role          TeamRole `thrift:"role,4" form:"role" json:"role"`
}
...
type GetTeamMembersResp struct {
	Members  []*TeamMember    `thrift:"members,1" form:"members" json:"members" query:"members"`
	PageResp *common.PageResp `thrift:"page_resp,2,optional" form:"page_resp" json:"page_resp,omitempty" query:"page_resp"`
	BaseResp *common.BaseResp `thrift:"base_resp,3" form:"base_resp" json:"base_resp" query:"base_resp"`
}
...
type GetUserInvitationsResp struct {
	Invitations []*TeamInvitation `thrift:"invitations,1" form:"invitations" json:"invitations" query:"invitations"`
	PageResp    *common.PageResp  `thrift:"page_resp,2,optional" form:"page_resp" json:"page_resp,omitempty" query:"page_resp"`
	BaseResp    *common.BaseResp  `thrift:"base_resp,3" form:"base_resp" json:"base_resp" query:"base_resp"`
}
