...
type KolInfo struct {
	...
	Languages    []*KolLanguage `thrift:"languages,14" form:"languages" json:"languages" query:"languages"`
	Tags         []*KolTag      `thrift:"tags,15" form:"tags" json:"tags" query:"tags"`
...
type ApplyKolReq struct {
	...
	// ["en", "zh"]
	LanguageCodes []string `thrift:"language_codes,9" form:"language_codes" json:"language_codes"`
	// ["English", "中文"]
	LanguageNames []string `thrift:"language_names,10" form:"language_names" json:"language_names"`
	// ["Defi", "Web3"]
	Tags []string `thrift:"tags,11" form:"tags" json:"tags"`
}
...
type UpdateKolInfoReq struct {
	...
	XURL          *string  `thrift:"x_url,7,optional" form:"x_url" json:"x_url,omitempty"`
	DiscordURL    *string  `thrift:"discord_url,8,optional" form:"discord_url" json:"discord_url,omitempty"`
	LanguageCodes []string `thrift:"language_codes,9,optional" form:"language_codes" json:"language_codes,omitempty"`
	LanguageNames []string `thrift:"language_names,10,optional" form:"language_names" json:"language_names,omitempty"`
	Tags          []string `thrift:"tags,11,optional" form:"tags" json:"tags,omitempty"`
}
...
type GetKolPlansResp struct {
	BaseResp *common.BaseResp `thrift:"base_resp,1" form:"base_resp" json:"base_resp" query:"base_resp"`
	Plans    []*KolPlan       `thrift:"plans,2" form:"plans" json:"plans" query:"plans"`
}
...
type GetKolVideosResp struct {
	BaseResp *common.BaseResp `thrift:"base_resp,1" form:"base_resp" json:"base_resp" query:"base_resp"`
	Videos   []*KolVideo      `thrift:"videos,2" form:"videos" json:"videos" query:"videos"`
...
type GetKolListResp struct {
	BaseResp *common.BaseResp `thrift:"base_resp,1" form:"base_resp" json:"base_resp" query:"base_resp"`
	KolList  []*KolInfo       `thrift:"kol_list,2" form:"kol_list" json:"kol_list" query:"kol_list"`
	Total    int64            `thrift:"total,3" form:"total" json:"total" query:"total"`
}
