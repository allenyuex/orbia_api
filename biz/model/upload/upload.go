...
type GenerateUploadTokenReq struct {
	ImageType ImageType `thrift:"image_type,1,required" form:"image_type,required" json:"image_type,required"`
	// 文件扩展名，如 .jpg, .png
...
type ValidateImageURLReq struct {
	...
	ImageType ImageType `thrift:"image_type,2,required" form:"image_type,required" json:"image_type,required"`
}
